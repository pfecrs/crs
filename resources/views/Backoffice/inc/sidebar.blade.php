        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            <li class="menu">
                ...
                <ul class="submenu list-unstyled collapse show" id="starter-kit" data-parent="#accordionExample" style="">
                    ...
                    <li @if (Route::is('*Entreprise'))  class="active"   @endif>
                        <a href="{{route('showListeEntreprise')}}"> Enreprises </a>
                    </li>
                    <li @if (Route::is('*Document')) class="active"  @endif>
                        <a href="{{route('showListeDocument')}}"> Documents </a>
                    </li>
                </li>
                <li @if (Route::is('*User')) class="active"  @endif>
                        <a href="{{route('showListeUser')}}"> Users </a>
                    </li>
                    <li @if (Route::is('*Article')) class="active"  @endif>
                        <a href="{{route('showListeArticle')}}"> Articles </a>
                    </li>
                    <li @if (Route::is('*Reclamtion')) class="active"  @endif>
                        <a href="{{route('showListeReclamations')}}"> Reclamations </a>
                    </li>
                </ul>
            </li>
