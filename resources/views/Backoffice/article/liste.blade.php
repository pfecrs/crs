                ...
                <div class="mail-box-container">
                    ...
                    <div class="tab-title">
                        <div class="row">
                            ...
                            <a class="btn" id="addTask" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg> Nouveau Article</a>
                        </div>
                    </div>
                                ...
                                <div class="todo-item all-list ">
                                    <div class="todo-item-inner">
                                        ...
                                        <div class="todo-content">
                                            ...
                                            <p class="todo-text" data-todoHtml="{{$article->contenu}}" data-todoText='{"ops":[{"insert":"{{$article->contenu}}"}]}'> {{$article->contenu}}</p>
                                        </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                                        ...
                                        <form method="POST" action="">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="d-flex mail-to mb-4">
                                                        ...
                                                        <div class="w-100">
                                                            <input id="task" type="text" placeholder="Titre" class="form-control" name="task" required>
                                            ...
                                            <div class="row">
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text flaticon-menu-list"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
                                                        ...
                                                        <div class="w-100">
                                                            <input id="task" type="file"  class="form-control-file" name="task" >
                                                            <span class="validation-text"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="d-flex mail-to mb-4">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-3 flaticon-notes"><path d="M12 20h9"></path><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path></svg>
                                                        <div class="w-100">
                                                            <input id="task" type="text" placeholder="Creér par" class="form-control" name="task" required>
                                                            <span class="validation-text"></span>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="modal-footer">
                                ...
                                <button class="btn add-tsk">Nouveau Article</button>
